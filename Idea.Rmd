...
us.map$PADD[us.map$region %in% 
          c('connecticut','maine','massachusetts','new hampshire','new jersey','new york', 'pennsylvania','rhode island','vermont')] <- "Northeast"
us.map$PADD[us.map$region %in% 
...
us.map$lat.transp[us.map$PADD == "South"] <- us.map$lat[us.map$PADD == "South"] - 5
us.map$long.transp[us.map$PADD == "South"] <- us.map$long[us.map$PADD == "South"] - 4
us.map$lat.transp[us.map$PADD == "Northeast"] <- us.map$lat[us.map$PADD == "Northeast"] - 3
us.map$long.transp[us.map$PADD == "Northeast"] <- us.map$long[us.map$PADD == "Northeast"]
us.map$lat.transp[us.map$PADD == "North Central"] <- us.map$lat[us.map$PADD == "North Central"]
us.map$long.transp[us.map$PADD == "North Central"] <- us.map$long[us.map$PADD == "North Central"] - 5
us.map$lat.transp[us.map$PADD == "West"] <- us.map$lat[us.map$PADD == "West"] - 2
us.map$long.transp[us.map$PADD == "West"] <- us.map$long[us.map$PADD == "West"] - 10
colnames(us.map)[7] = 'Region'
# add labels
