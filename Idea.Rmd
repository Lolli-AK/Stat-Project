...
years = year_2023 %>%  inner_join(year_2018) %>% inner_join(year_2013) %>% inner_join(year_2008) %>% inner_join(year_2003)
```
...
ggplot(year_2008, aes(x = rent_08, fill = region)) + 
  geom_density(alpha = 0.3)+ 
    labs(x = "Rent Price", y = "Density",  
         title = "Rent Prices by Region", subtitle = "3 Bedroom in 2008") +
    guides(fill = guide_legend(title = "Region")) 

ggplot(year_2008, aes(x = region, y = rent_08, fill = region)) + 
